...
def main():
    ...
    import nibabel as nb
    import nibabel.freesurfer.mghformat as fsio
    import numpy as np
    from scipy import io
    import transformations as tf
    import vtk
    ...
    def main():
        ...
        if SHOW_FREESURFER:
            ...
            fs_actor = load_stl(fs_file, ren, colour=[1., 0., 1.], opacity=0.5, user_matrix=trans_fs)
    ...
    def load_stl(stl_path, ren, opacity=1., visibility=1, position=False, colour=False, replace=False,
